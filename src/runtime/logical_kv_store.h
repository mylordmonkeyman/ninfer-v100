...
public:
    ...
    [[nodiscard]] friend bool operator==(HostKVExtentCapability a,
                                         HostKVExtentCapability b) noexcept {
...
public:
    ...
    [[nodiscard]] friend bool operator==(LogicalKVPageHandle a,
                                         LogicalKVPageHandle b) noexcept {
        return a.owner_ == b.owner_ && a.index_ == b.index_ && a.generation_ == b.generation_;
    }
...
public:
    ...
    [[nodiscard]] friend bool operator==(KVAddressSpaceHandle a,
                                         KVAddressSpaceHandle b) noexcept {
        return a.owner_ == b.owner_ && a.index_ == b.index_ && a.generation_ == b.generation_;
    }

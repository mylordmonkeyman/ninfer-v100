...
struct PrefixShortlistKey {
    ...
    [[nodiscard]] friend constexpr bool operator==(const PrefixShortlistKey& a,
                                                   const PrefixShortlistKey& b) noexcept {
        return a.digests == b.digests && a.frontier == b.frontier && a.identity_tag == b.identity_tag;
    }
};
...
struct TargetKVRequirement {
    ...
    [[nodiscard]] friend constexpr bool operator==(TargetKVRequirement a,
                                                   TargetKVRequirement b) noexcept {
        return a.main_frontier == b.main_frontier && a.backend_frontier == b.backend_frontier &&
               a.main_pages == b.main_pages && a.backend_pages == b.backend_pages;
    }
};
...
public:
    ...
    [[nodiscard]] friend constexpr bool operator==(PressureTargetHandle a,
                                                   PressureTargetHandle b) noexcept {
        return a.session_ == b.session_ && a.generation_ == b.generation_ && a.index_ == b.index_;
    }

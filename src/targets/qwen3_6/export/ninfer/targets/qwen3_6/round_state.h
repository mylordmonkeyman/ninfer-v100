...
struct OrdinaryDecodeIngress {
    ...
    std::array<std::int32_t, kMaximumConcurrency> next_cache_positions{};
    std::array<std::int32_t, kMaximumConcurrency> rope_positions{};
    std::array<std::int32_t, kMaximumConcurrency> text_kv_table_rows{};
    std::array<std::int32_t, kMaximumConcurrency> backend_kv_table_rows{};
...
struct OrdinaryDecodeState {
    ...
    Tensor next_cache_positions;
    Tensor rope_positions;
    Tensor text_kv_table_rows;
    Tensor backend_kv_table_rows;
    Tensor active_lanes;

...
#pragma unroll
                    ...
                    ::ninfer::ops::volta_mma884_f16_f32_raw(c[tile][0 % NACC], A[0], A[1], B[0], B[1]); // k slice 0
                    ::ninfer::ops::volta_mma884_f16_f32_raw(c[tile][1 % NACC], A[2], A[3], B[2], B[3]); // k slice 1
                }
            }
        }
    }

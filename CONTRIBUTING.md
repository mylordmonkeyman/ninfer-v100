...
`research/qwen4-flash-next` branch, the default development branch of this fork. Before implementation,
review open pull requests targeting that branch to avoid duplicating or conflicting with ongoing work.
